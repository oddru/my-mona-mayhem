...
- Name: tests\e2e\playwright.spec.js >> shows validation error when fields are empty
- Location: tests\e2e\playwright.spec.js:57:1
...
- main:
  ...
  - textbox "Player 2"
  - button "Battle!"
  - text: Player 1 is required VS Player 2 is required Mona Mayhem — Retro edition
```
