...
- Name: tests\e2e\playwright.spec.js >> handles upstream 404 (user not found) gracefully
- Location: tests\e2e\playwright.spec.js:75:1
...
Locator: locator('#results .player .error')
...
Call log:
  ...
  - waiting for locator('#results .player .error')
...
- main:
  ...
  - text: Player 1
  - textbox "Player 1" [disabled]: octocat
  - text: Player 2
  - textbox "Player 2" [disabled]: nouserfound
  - button "Battle!" [disabled]
  - text: octocat VS nouserfound No data Mona Mayhem — Retro edition
```
