...
- Name: tests\e2e\playwright.spec.js >> shows validation error for invalid username pattern
- Location: tests\e2e\playwright.spec.js:65:1
...
Expected substring: "Please enter two valid GitHub usernames."
Timeout: 5000ms
...
- main:
  ...
  - text: Player 1
  - textbox "Player 1": bad user
  - text: Player 2
  - textbox "Player 2": torvalds
  - button "Battle!"
  - text: bad user Invalid username format VS Mona Mayhem — Retro edition
```
